...
export const Settings: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState(9); // 9 is the index for Settings in AdminSidebar
  ...
  useEffect(() => {
    // Only fetch users when authenticated admin AND company exists
  ...
  const fetchUsers = async () => {
    try {
      ...
      // Provide clearer message when company is missing
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                    <Paper sx={{ p: 2, bgcolor: 'info.light' }}>
                      ...
                      <Typography variant="body2" color="text.secondary" gutterBottom>
                        Remove all demo and test data from the system.
                      </Typography>
                      {user?.role === 'admin' && (
                        <Button
                          variant="contained"
                          color="info"
                          onClick={() => {/* Handle purge data */}}
                        >
                          Purge Data
                        </Button>
                      )}
