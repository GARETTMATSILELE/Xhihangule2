...
router.get('/tenant-ledger', async (req, res) => {
  try {
    ...
    // Limited mock data for public access
    const mockData = {
      tenantId: tenantId as string || 'public-tenant-1',
      tenantName: 'Sample Tenant',
      propertyName: 'Sample Property',
      unitNumber: '101',
      transactions: [
...
router.get('/capital-expenditure', async (req, res) => {
  try {
...
router.get('/eviction', async (req, res) => {
  try {
