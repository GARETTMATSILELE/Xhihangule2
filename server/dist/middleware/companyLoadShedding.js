...
exports.createPerCompanyRateLimiter = exports.createPerCompanyConcurrencyGuard = void 0;
const operationInflight = new Map();
const operationRateBuckets = new Map();
...
const createPerCompanyConcurrencyGuard = (options) => {
...
exports.createPerCompanyConcurrencyGuard = createPerCompanyConcurrencyGuard;
const createPerCompanyRateLimiter = (options) => {
...
exports.createPerCompanyRateLimiter = createPerCompanyRateLimiter;
