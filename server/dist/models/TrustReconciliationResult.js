...
exports.TrustReconciliationResult = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const collections_1 = require("../config/collections");
const TrustReconciliationResultSchema = new mongoose_1.Schema({
    ...
    details: { type: mongoose_1.Schema.Types.Mixed, required: true, default: {} }
}, { timestamps: true });
TrustReconciliationResultSchema.index({ companyId: 1, runAt: -1 });
exports.TrustReconciliationResult = mongoose_1.default.model('TrustReconciliationResult', TrustReconciliationResultSchema, collections_1.COLLECTIONS.TRUST_RECONCILIATION_RESULTS);
