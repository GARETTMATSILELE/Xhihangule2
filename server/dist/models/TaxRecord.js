...
exports.TaxRecord = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const collections_1 = require("../config/collections");
const TaxRecordSchema = new mongoose_1.Schema({
    ...
    calculationBreakdown: { type: mongoose_1.Schema.Types.Mixed, required: false },
...
exports.TaxRecord = mongoose_1.default.model('TaxRecord', TaxRecordSchema, collections_1.COLLECTIONS.TAX_RECORDS);
